...
inline bool RemoveFile(const string& fpath)
{
	...
	{
		res = false;
		cout << "[ERROR] remove file: "<< fpath << " line=" << __LINE__ << endl;	
	}
	else
	{
		res = true;
		cout << "[OK] remove file: " << fpath<<" line=" << __LINE__ << endl;		
	}	
	return res;
}
...
inline bool IdxIvtCheck(const string& fpath_idx, const string& fpath_ivt)
{
	...
	{
		cout << "[Error] open file: " << fpath_idx << " " << __LINE__ << endl;
		return false;
	}
	...
	{
		cout << "[Error] open file: " << fpath_ivt << " " << __LINE__ << endl;
		return false;
	}
